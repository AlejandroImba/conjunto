...
<div class="container">
    ...
    <div class="mb-3 text-center">
        <button onclick="window.location.href='/ismac-libreria-nocturno-web/autores/findOne?opcion=1'; return false;" class="btn btn-primary">Agregar Autor</button>
    </div>
        ...
        <tbody>
            <c:forEach var="item" items="${autores}">
                <tr>
                    ...
                    <td>${item.correo}</td>
                    <td>
                        <button onclick="window.location.href='/ismac-libreria-nocturno-web/autores/findOne?opcion=1&idAutor=${item.idAutor}'; return false;" class="btn btn-primary btn-sm">Actualizar</button>
                        <button onclick="window.location.href='/ismac-libreria-nocturno-web/autores/findOne?opcion=2&idAutor=${item.idAutor}'; return false;" class="btn btn-danger btn-sm">Borrar</button>
                    </td>
                </tr>
            </c:forEach>
        </tbody>
