...
<div class="container">
    ...
    <div class="mb-3 text-center">
        <button id="btnAgregar" name="btnAgregar" 
        onclick="window.location.href='/ismac-libreria-nocturno-web/clientes/findOne?opcion=1'; return false;" 
        class="btn btn-primary">Agregar Cliente</button>
    </div>
